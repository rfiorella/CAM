...
call wtrc_apply_rates(state, ptend, pbuf, top_lev, dtime, .true., precr, preci, pre_rates_in=pre_rates_grid,    &
                                ...
                                sedlat=wtsedlat, postlat=wtpostlat, frzpre=frzro, mltpre=meltso, wtfri_pre=wtfri_pre)
...
!=======================================================================
  subroutine wtrc_apply_rates(pstate, ptend_sum, pbuf, top_lev, dtime, micro, precr, preci, pre_rates_in, post_rates, do_stprecip, &
